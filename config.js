...
global.anitav4 = process.env.BOT_NAME || "SENUX MD BOT ✨️🇾🇪💛";
global.ownername = process.env.OWNER_NAME || "CSWSENU";
global.packname = process.env.PACK_NAME || "SENURA LAKSHAN 🌏❤️";
global.author = process.env.AUTHOR || "SLP";
global.channelname = process.env.CHANNEL_NAME || "කාටුන් ලෝකේ 💛";
